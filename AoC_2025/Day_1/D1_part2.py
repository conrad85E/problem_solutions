def rotate(direction: str, steps: int, start: int) -> tuple[int, int]:
    '''
    Performs one rotation of a dial and returns end position and number of times 0 digit was passed.
    ...
    :return: Tuple of the [new position] and [number of passes of 0 digit during the rotation].
    :rtype: tuple[int, int]
    '''
